class AdobeJob < ApplicationJob
  ...
  def perform(course_id, module_id,  m, id)
    agent = Mechanize.new
    ...
    form.username    = 'adminelearn'
    form.password = '12345678'
    form.submit
    
    course = agent.get 'https://elearn5.ut.ac.ir/mod/adobeconnect2/view.php?id='+course_id
